...
export default function TopicGeneratorForm() {
    ...
    return (
        <form
            ...
            className="mt-10 w-full max-w-2xl rounded-3xl border border-slate-200 bg-white p-4 shadow-sm"
        >
            <div className="flex flex-col gap-4">
                ...
                <button
                    ...
                    className="rounded-2xl bg-slate-900 px-6 py-3 text-sm font-medium text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
                >
